...
## Introduction
Auto RPG is a **3D Multiplayer Online Role Playing Game (MMORPG)** that runs in the browser. It combines classic RPG elements (Exploration, Combat, Loot) with modern "idle" mechanics (Auto-Farm) and a dynamic 3D world built with Three.js.
